...
opts = Trollop::options do
  ...
  opt :hostedzone, "The hosted zone name that should be switched to point to the new address (This is the domain. For example, for demo.elasticoperations.com, you'd punch in 'stelligent.com')", :type => String, :required => true
